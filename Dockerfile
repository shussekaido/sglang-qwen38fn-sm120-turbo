...
#   0005  evict abandoned requests: an abort whose tokenizer state is already gone still reaches the scheduler, the prefill loop stops latching the queue behind a budget it consumed itself, running-batch aborts log at INFO
